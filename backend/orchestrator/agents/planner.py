...
async def planner_node(state: AgentState, config: RunnableConfig) -> AgentState:
    ...
    try:
        ...
        system_prompt = (
            ...
            "- If the user's query is a standalone command to create a goal/space/project without referencing any uploaded documents (e.g., 'create a goal to learn DSA with 3 tasks'), set needs_research to false so the system immediately routes to decision analysis and action execution.\n"
