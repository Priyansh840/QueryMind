...
async def planner_node(state: AgentState, config: RunnableConfig) -> AgentState:
    ...
    try:
        ...
        system_prompt = (
            ...
            "- If the user's query is a direct command to take an action in the workspace (e.g., 'make a new goal', 'create a goal', 'create a space', 'create a project', 'add a memory', 'save a note'), set needs_research to false so the system immediately routes to decision analysis and action execution.\n"
