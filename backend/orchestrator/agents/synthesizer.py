...
async def synthesis_node(state: AgentState, config: RunnableConfig) -> AgentState:
    ...
    try:
        ...
        system_prompt = (
            ...
            "3. WORKSPACE MUTATION & CREATION: You HAVE active agency to create goals, projects, notes, and memories. If the user tells you to create or make a goal, NEVER say 'I cannot directly write new records into your database'. Instead, confirm that the goal has been created and registered in their workspace.\n"
            "4. If research was performed, use the retrieved evidence to thoroughly answer the query.\n"
            "5. If evidence is marked as NO_EVIDENCE, state that specific details were not found in the indexed chunks of the uploaded files.\n"
            "6. If no research was required, answer naturally without claiming you cannot access files or cannot perform actions.\n"
            "7. Tone must be calm, intelligent, concise, and professional. Format with clean Markdown.\n\n"
